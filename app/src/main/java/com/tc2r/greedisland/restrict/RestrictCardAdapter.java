        ...
        switch (holder.getItemViewType()) {
            case 1:
                ...
                if (local) {
                    ...
                    Glide.with(context).load(cardList.get(position).getImageItem()).placeholder(R.drawable.placeholder).centerCrop().into(viewHolder1.card_image);
                } else {
                    viewHolder1.card_description.setText(restrictCard.description);
                    viewHolder1.card_title.setText(restrictCard.getTitle());
                    ...
                    Glide.with(context).load(newUrl).placeholder(R.drawable.placeholder).centerCrop().crossFade().into(viewHolder1.card_image);
