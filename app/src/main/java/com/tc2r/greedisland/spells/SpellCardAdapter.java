...
public class SpellCardAdapter extends RecyclerView.Adapter<SpellCardAdapter.ViewHolder> {
		...
		switch (spellCard.getId()) {
			...
			case 6:
				...
				builder = new AlertDialog.Builder(v.getContext())
								.setTitle("Activate Spell Card")
								.setMessage("Use " + spellCard.getName() + " Now?")
								.setPositiveButton("Gain!", new DialogInterface.OnClickListener() {
									@Override
	...
	private void AddToken(View v) {
		...
		final String location = settings.getString("CurrentLocation", "Start");
